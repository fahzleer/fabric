    ...
    <>
      ...
      <nav aria-label="breadcrumb" className="mb-6 text-sm text-muted-foreground">
        <ol className="flex items-center gap-1">
          ...
          <li aria-hidden="true">/</li>
          <li className="text-foreground font-medium">ชำระด้วย Crypto</li>
        </ol>
      </nav>
      ...
      <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-border pt-8">
        <div>
          <h2 className="text-lg font-semibold text-foreground">พร้อมใช้ USDC ชำระเงิน?</h2>
          <p className="text-sm text-muted-foreground">สมัครบัญชีฟรี แล้วช้อปด้วย Crypto Wallet</p>
        </div>
